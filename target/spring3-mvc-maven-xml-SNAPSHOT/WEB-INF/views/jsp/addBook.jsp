...
<nav class = "navbar navbar-inverse navbar-fixed-top">
    <div class = "container">
        <div class = "navbar-header">
            <a class = "navbar-brand" href = "#">Adding Book</a>
        </div>
    </div>
</nav>
...
<h1>${title}</h1>
<form class = "form-horizontal" role="form" action = "/a/book/adding" >
    ...
    <div class = "form-group">
        ...
        <div class = "col-md-10">
            <input name = "year" type = "text" class = "form-control" id = "Year" placeholder = "2016">
        </div>
    </div>
    <div class = "form-group">
        ...
        <div class = "col-md-10">
            <select name = "author" id = "author" class="form-control">
                <option selected disabled>Chose author</option>
    ...
    <div class = "form-group">
        ...
        <div class = "col-md-10">
            <input name = "isbn" type = "text" class = "form-control" id = "isbn" placeholder = "1-1-1-1">
        </div>
    </div>
